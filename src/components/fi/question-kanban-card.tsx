...
// import Link from 'next/link'; // Removed as we use Dialog now
import {
    Dialog,
    DialogContent,
    DialogHeader,
    ...
    return (
        <Dialog>
                            ...
                            <div className="space-y-2">
                                ...
                                {question.answer && (
                                    <div className="bg-emerald-50/50 p-2 rounded text-xs text-slate-700 border border-emerald-100 italic truncate max-w-full">
                                        "{typeof question.answer === 'object' ? "[Structured value]" : String(question.answer)}"
                                    </div>
                                )}
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    {/* Header handled inside detail view or customized here? 
                        The QuestionDetailView has a header. Let's hide the default DialogHeader or keep it minimal. 
                    */}
