...
export function GleifTab({ data, fetchedAt }: GleifTabProps) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {data.nationalRegistryData && data.nationalRegistryData.officers && (
                        ...
                        <CardHeader className="pb-3 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/20">
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-base flex items-center gap-2">
                                    ...
                                    Directors & Officers (National Registry)
                                </CardTitle>
                                <Badge variant="outline" className="bg-white dark:bg-slate-800 text-slate-500 font-normal">
                                    Source: {data.nationalRegistryData.source}
                                </Badge>
                            </div>
                            <CardDescription>
                                Official officer data fetched directly from Companies House (GB).
                            </CardDescription>
                        </CardHeader>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm text-left">
                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                        {data.nationalRegistryData.officers.map((officer: any, idx: number) => (
