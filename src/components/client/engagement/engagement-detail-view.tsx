...
export function EngagementDetailView({
    ...
    const handleDeleteQuestionnaireConfirm = async () => {
    ...
    return (
        <div className="space-y-6">
                                                                ...
                                                                <DropdownMenu>
                                                                    ...
                                                                    <DropdownMenuContent align="end">
                                                                        ...
                                                                        <DropdownMenuItem onClick={() => setShareTarget({ id: q.id, name: q.name })}>
                                                                         ...
                                                                         <DropdownMenuItem className="text-red-600" onSelect={(e) => { e.preventDefault(); setRemoveTarget({ id: q.id, name: q.name }); }}>
            ...
            <ConfirmDeleteDialog
                ...
                description={removeTarget ? `This will remove "${removeTarget.name}" from this engagement.` : ""}
                confirmLabel="Remove Questionnaire"
                onConfirm={handleDeleteQuestionnaireConfirm}
            />
