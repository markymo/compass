...
import { AddressMappingAssistant } from "./address-mapping-assistant";
...
export function DataInspectorPanel({ 
    ...
    // Phase 2 State handled by AddressMappingAssistant
    ...
    return (
        <Card className="flex flex-col h-[calc(100vh-12rem)] sticky top-6">
            ...
            {activeAddressCandidate && (
                <AddressMappingAssistant
                    open={true}
                    onOpenChange={(open) => {
                        if (!open) setActiveAddressCandidate(null);
                    }}
                    sourceType={sourceType}
                    sourceReference={sourceReference || null}
                    sourcePath={activeAddressCandidate.path}
                    nodeValue={activeAddressCandidate.value}
                    heuristicResult={activeAddressCandidate.heuristicResult}
