...
import {
    ...
    ChevronDown, ChevronRight, FileText, Users, Briefcase,
...
export default function Dashboard2Page() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
            ...
            {/* Footer link to old dashboard */}
            <div className="pt-4 border-t border-slate-100 text-center">
                <Link href="/app/welcome" className="text-xs text-slate-400 hover:text-slate-600 transition-colors">
