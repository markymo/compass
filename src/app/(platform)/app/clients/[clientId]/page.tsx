...
import { Landmark, ArrowRight, Building2, Users, CreditCard, Activity, Shield, User, Home } from "lucide-react";
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <StandardPageHeader
                ...
                subtitle={`Manage your legal entities and banking relationships for ${org.name}.`}
                breadcrumbs={[
