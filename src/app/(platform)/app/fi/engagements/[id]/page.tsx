...
import { ArrowLeft, CheckCircle2, Clock, FileText, ArrowRight, AlertCircle, Shield, Home, Landmark, Building2 } from "lucide-react";
...
export default async function FIEngagementOverviewPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            />
            <div className="space-y-6 fade-in duration-500 max-w-7xl mx-auto pb-10 px-6 pt-6 w-full">
                {/* Header Area */}
                <div>
                    <div className="flex items-start justify-between">
                        <div>
                            <div className="flex items-center gap-3 mb-1">
                                <h1 className="text-3xl font-bold text-slate-900">Relationship Overview</h1>
