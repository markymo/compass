...
// Tooltip removed as it was unused and missing
...
export default function ManageQuestionnairePage() {
    ...
    function updateItem(index: number, field: keyof ExtractedItem, value: any) {
        ...
        // Intelligence: If setting masterKey, clear category? Or keep it?
        // Let's keep it independent for now, but UI logic will visually prioritize Key.
    ...
    const iframeSrc = `/api/questionnaires/${id}/download`;
    // We only show iframe for PDF for now
                            ...
                            <div key={sIdx} className="space-y-3">
                                ...
                                <div className="space-y-3 pl-2">
                                    {section.items.map(({ item, originalIndex }) => {
                                        ...
                                        if (!isQuestion) return null; // Should mostly accept questions in this view, maybe INSTRUCTIONS too later?
