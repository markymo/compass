                        ...
                        <div className="grid gap-12 md:grid-cols-[300px_1fr] items-start">
                            ...
                            <div>
                                ...
                                <div className="space-y-4 text-slate-600 text-lg leading-relaxed">
                                    ...
                                    <p>
                                        He has overseen hedging processes for more than <strong>£40bn</strong> of infrastructure debt issuance, executing some of the largest trades in the market. It is this deep operational experience that drives the Compass mission: to eliminate the administrative overhead that burdens modern capital markets.
                                    </p>
