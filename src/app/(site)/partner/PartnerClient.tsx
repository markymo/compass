...
const steps = [
    {
        ...
        description: `Upload a set of information requirements to ${BRAND.name} (for example – UK large corporates).`,
        image: step1,
        color: "amber"
    },
    {
        ...
        description: `${BRAND.name} integrates your data requirements into its standard data set, expanding it if necessary.`,
        image: step2,
        color: "slate"
    },
    {
