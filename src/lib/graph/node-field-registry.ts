...
export const NODE_FIELD_REGISTRY: NodeFieldDefinition[] = [
    ...
    },
    {
        ...
        dataType:     "COUNTRY_CODE",
        storageKind:  "SYSTEM_COLUMN",
        storagePath:  "person.countryOfResidence",
        scope:        "GLOBAL",
        isSystem:     true,
        isSearchable: true,
        isDisplayable: true,
    ...
    {
        fieldKey:     "officerRole",
        nodeType:     "PERSON",
        label:        "Officer Role",
        dataType:     "TEXT",
        storageKind:  "SYSTEM_COLUMN",
        storagePath:  "person.officerRole",
        scope:        "GLOBAL",
        isSystem:     true,
        isSearchable: true,
        isDisplayable: true,
    ...
    },
    {
        ...
        dataType:     "TEXT",
        storageKind:  "SYSTEM_COLUMN",
        storagePath:  "legalEntity.jurisdiction",
        scope:        "GLOBAL",
        isSystem:     true,
        isSearchable: true,
        isDisplayable: true,
    ...
    },
    {
        ...
        dataType:     "TEXT",
        storageKind:  "SYSTEM_COLUMN",
        storagePath:  "legalEntity.legalForm",
        scope:        "GLOBAL",
        isSystem:     true,
        isSearchable: false,
        isDisplayable: true,
    ...
    },
    {
        ...
        dataType:     "TEXT",
        storageKind:  "SYSTEM_COLUMN",
        storagePath:  "legalEntity.entityStatus",
        scope:        "GLOBAL",
        isSystem:     true,
        isSearchable: false,
        isDisplayable: true,
    ...
    {
        fieldKey:     "countryOfIncorporation",
        nodeType:     "LEGAL_ENTITY",
        label:        "Country of Incorporation",
        dataType:     "COUNTRY_CODE",
        storageKind:  "SYSTEM_COLUMN",
        storagePath:  "legalEntity.countryOfIncorporation",
        scope:        "GLOBAL",
        isSystem:     true,
        isSearchable: true,
        isDisplayable: true,
